(() => {
                    ...
                    async (e, r) => {
                        try {
                            var o = a(5351),
                                ...
                                s = a(9037);
                            (await (async () => {
                                const e = await (0, t.p)(null, 'getURL', null);
                                console.log(`URL: ${e}`);
                                const r = new URL(e).searchParams;
                                if (r.has('api_key')) {
                                    const e = r.get('api_key');
                                    (console.log(`Extracted api_key: ${e}`), await (0, s.dL)(o.A.API_KEY.key, e));
                                }
                            })(),
                                r());
                        } catch (e) {
                ...
                async function o(e, r, a) {
                    ...
                    try {
                        return await new Promise((t, s) => {
                            o.sendMessage({ source: e, type: r, data: a }, (e) => {
                                o.lastError ? s(new Error(`Error sending message: ${o.lastError.message}`)) : t(e);
                            });
                        });
                    } catch (e) {
            ...
            9037: (e, r, a) => {
                ...
                const t = async (e, r) => {
                    ...
                    try {
                        return (
                            (o = o.then(
                                () =>
                                    new Promise((o, s) => {
                                        a.set({ [e]: r }, () => {
                                            t.lastError ? s(new Error(`Error setting ${e}: ${t.lastError.message}`)) : (console.debug(`[storageHelpers] Setting ${e}:`, r), o(!0));
                                        });
                                    })
                            )),
                            await o,
                        ...
                        throw (console.error(`[storageHelpers] Error setting ${e}:`, r), r);
                    }
                };
            }
        },
    ...
    ((e = 'function' == typeof Symbol ? Symbol('webpack queues') : '__webpack_queues__'),
        ...
        (l.a = (t, s, l) => {
            ...
            ((y[r] = d),
                (y[e] = (e) => (n && e(n), u.forEach(e), y.catch((e) => {}))),
                (t.exports = y),
                s(
                    (t) => {
                        var s;
                        ...
                        var l = () =>
                            ...
                            c = new Promise((r) => {
                                (s = () => r(l)).r = 0;
                                var a = (e) => e !== n && !u.has(e) && (u.add(e), e && !e.d && (s.r++, e.push(s)));
                                i.map((r) => r[e](a));
                            });
                        return s.r ? c : l();
                    },
        ...
        (l.d = (e, r) => {
            for (var a in r) l.o(r, a) && !l.o(e, a) && Object.defineProperty(e, a, { enumerable: !0, get: r[a] });
        }),
